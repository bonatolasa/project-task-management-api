            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    <div style={{ background: '#fff', borderRadius: 16, padding: '24px', border: '1px solid #f3f4f6' }}>
                        <h3 style={{ fontSize: '16px', fontWeight: 600, marginBottom: '16px' }}>Assignees</h3>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            {task.assignedTo.length === 0 ? (
                                <div style={{ fontSize: '14px', color: '#9ca3af' }}>No one assigned yet</div>
                            ) : (
                    ...
                    <div style={{ background: '#fff', borderRadius: 16, padding: '24px', border: '1px solid #f3f4f6' }}>
                        <h3 style={{ fontSize: '16px', fontWeight: 600, marginBottom: '16px' }}>Created By</h3>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
